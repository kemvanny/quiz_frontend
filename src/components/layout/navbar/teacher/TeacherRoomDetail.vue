        ...
        <div class="room-hd w-100 me-3">
          <div class="room-hd-left">
            ...
            <div>
              ...
              <div class="page-title">Today Exams <span class="title-dot">.</span></div>
            </div>
          </div>
          <span class="hd-count">{{ examCount }} វិញ្ញាសា</span>
        </div>
      </div>

      <div class="profile-dropdown-trigger d-flex align-items-center gap-2 p-1 pe-2 rounded-pill flex-shrink-0">
        <img :src="authStore.avatarUrl" alt="avatar" class="avatar-image" />
        
        <div class="d-none d-sm-flex flex-column justify-content-center pe-2 text-container">
          <span class="fw-bold profile-name">{{ authStore.fullName }}</span>
...
/* Scoped Hover Interaction Elements Mapping */
